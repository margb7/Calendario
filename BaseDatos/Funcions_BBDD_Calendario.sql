...
CREATE PROCEDURE CREAR_EVENTO(IN NOM_EV VARCHAR(25), IN DATA_EV DATE, IN HORA_EV TIME, IN NOM_USER ,IN TIPO BYTE)
	MODIFIES SQL DATA
    BEGIN
        ...
        CASE TIPO
			WHEN 1				-- Privado
				THEN 
					...
					INSERT INTO EVENTOS_PRIVADOS (CLAVE_EVENTO, OBTER_NUMERO_USUARIO(NOM_USER));
